  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-white text-secondary-900 border border-secondary-300 hover:bg-secondary-50 focus-visible:ring-primary-500',
        ghost: 'text-secondary-600 hover:text-primary-600 hover:bg-primary-50 focus-visible:ring-primary-500',
        ...
        success: 'bg-success-600 text-white hover:bg-success-700 focus-visible:ring-success-500 shadow-lg hover:shadow-xl',
        warning: 'bg-warning-600 text-white hover:bg-warning-700 focus-visible:ring-warning-500 shadow-lg hover:shadow-xl',
